...
proto.RecordedSegment.toObject = function(includeInstance, msg) {
  var f, obj = {
    beatsToTimestampsMap: (f = msg.getBeatsToTimestampsMap()) ? f.toObject(includeInstance, undefined) : [],
    timestampsToMidiDataMap: (f = msg.getTimestampsToMidiDataMap()) ? f.toObject(includeInstance, undefined) : []
  };
...
proto.RecordedSegment.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = msg.getBeatsToTimestampsMap();
      ...
      break;
    case 2:
      var value = msg.getTimestampsToMidiDataMap();
      reader.readMessage(value, function(message, reader) {
...
proto.RecordedSegment.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBeatsToTimestampsMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(1, writer, jspb.BinaryWriter.prototype.writeUint32, jspb.BinaryWriter.prototype.writeUint64);
  }
  f = message.getTimestampsToMidiDataMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(2, writer, jspb.BinaryWriter.prototype.writeUint64, jspb.BinaryWriter.prototype.writeBytes);
  }
};


/**
 * map<uint32, uint64> beats_to_timestamps = 1;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<number,number>}
 */
proto.RecordedSegment.prototype.getBeatsToTimestampsMap = function(opt_noLazyCreate) {
 ...
 */
proto.RecordedSegment.prototype.clearBeatsToTimestampsMap = function() {
  this.getBeatsToTimestampsMap().clear();
  return this;};


/**
 * map<uint64, bytes> timestamps_to_midi_data = 2;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<number,!(string|Uint8Array)>}
 */
proto.RecordedSegment.prototype.getTimestampsToMidiDataMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.RecordedSegment} returns this
 */
proto.RecordedSegment.prototype.clearTimestampsToMidiDataMap = function() {
  this.getTimestampsToMidiDataMap().clear();
  return this;};
