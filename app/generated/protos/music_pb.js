...
goog.exportSymbol('proto.MelodicData', null, global);
 ...
 * @constructor
 */
proto.MelodicData = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.MelodicData, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.MelodicData.displayName = 'proto.MelodicData';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.Melody.oneofGroups_ = [[100,101]];
...
proto.Melody.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    melodicData: (f = msg.getMelodicData()) && proto.MelodicData.toObject(includeInstance, f),
...
proto.Melody.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 100:
      var value = new proto.MelodicData;
      reader.readMessage(value,proto.MelodicData.deserializeBinaryFromReader);
      msg.setMelodicData(value);
      break;
    case 101:
...
proto.Melody.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getMelodicData();
  if (f != null) {
    writer.writeMessage(
      100,
      f,
      proto.MelodicData.serializeBinaryToWriter
    );
  }
...
/**
 * optional MelodicData melodic_data = 100;
 * @return {?proto.MelodicData}
 */
proto.Melody.prototype.getMelodicData = function() {
  return /** @type{?proto.MelodicData} */ (
    jspb.Message.getWrapperField(this, proto.MelodicData, 100));
};


/**
 * @param {?proto.MelodicData|undefined} value
 * @return {!proto.Melody} returns this
*/
proto.Melody.prototype.setMelodicData = function(value) {
  return jspb.Message.setOneofWrapperField(this, 100, proto.Melody.oneofGroups_[0], value);
};
 ...
 * @return {!proto.Melody} returns this
 */
proto.Melody.prototype.clearMelodicData = function() {
  return this.setMelodicData(undefined);
};
 ...
 * @return {boolean}
 */
proto.Melody.prototype.hasMelodicData = function() {
 ...
 * @return {!Object}
 */
proto.MelodicData.prototype.toObject = function(opt_includeInstance) {
  return proto.MelodicData.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.MelodicData} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.MelodicData.toObject = function(includeInstance, msg) {
  var f, obj = {
    dataMap: (f = msg.getDataMap()) ? f.toObject(includeInstance, proto.MelodicAttack.toObject) : []
  };
 ...
 * @return {!proto.MelodicData}
 */
proto.MelodicData.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.MelodicData;
  return proto.MelodicData.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.MelodicData} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.MelodicData}
 */
proto.MelodicData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = msg.getDataMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readSint32, jspb.BinaryReader.prototype.readMessage, proto.MelodicAttack.deserializeBinaryFromReader, 0, new proto.MelodicAttack());
         });
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.MelodicData.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.MelodicData.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.MelodicData} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.MelodicData.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDataMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(1, writer, jspb.BinaryWriter.prototype.writeSint32, jspb.BinaryWriter.prototype.writeMessage, proto.MelodicAttack.serializeBinaryToWriter);
  }
};


/**
 * map<sint32, MelodicAttack> data = 1;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<number,!proto.MelodicAttack>}
 */
proto.MelodicData.prototype.getDataMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<number,!proto.MelodicAttack>} */ (
...
/**
 * Clears values from the map. The map will be non-null.
 * @return {!proto.MelodicData} returns this
 */
proto.MelodicData.prototype.clearDataMap = function() {
  this.getDataMap().clear();
  return this;};
